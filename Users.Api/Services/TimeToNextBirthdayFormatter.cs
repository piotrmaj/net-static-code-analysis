...
namespace Users.Api.Services
{
    ...
    {
        private const int DaysLeftThreshold = 10;
        private const int LessThanAMonthThreashold = 30;
        private const int PickingGiftDaysThreshold = 90;

        public string Format(DateOnly birthDate)
        {
            if (birthDate == default)
            {
                throw new ArgumentException("Can't have default value", nameof(birthDate));
            }
            ...
            {
                return "Less than a month left to your birthday, better start inviting friends for the party";
            }
        ...
        private static int CalculateDaysToNextBirthday(DateOnly birthDate)
        {
